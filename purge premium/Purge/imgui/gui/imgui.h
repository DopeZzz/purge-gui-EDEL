...
namespace ImGui
{
    ...
    IMGUI_API bool          SimpleCheckbox(const char* label, bool* v, const char* hint = "");
    IMGUI_API bool          SoloKeybinBox(const char* label, const char* hint = "");
    ...
    IMGUI_API bool          SliderDouble(const char* label, double* v, int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0, const char* hint = "");
